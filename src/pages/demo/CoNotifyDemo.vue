...
<template>
  ...
  >
    <view class="p-lg">
      ...
      <view class="p-lg">
        <uv-button @click="showNotify('info')" type="primary" class="mt-2.2">
          显示信息提示
        </uv-button>
        <uv-button @click="showNotify('success')" type="success" class="mt-2.2">
          显示成功提示
        </uv-button>
        <uv-button @click="showNotify('error')" type="error" class="mt-2.2">
          显示错误提示
        </uv-button>
        <uv-button @click="showNotify('warning')" type="warning" class="mt-2.2">
          显示警告提示
        </uv-button>
        <uv-button @click="showNotify('primary')" type="primary" class="mt-2.2">
          显示主色调提示
        </uv-button>
      </view>
